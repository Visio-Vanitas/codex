...
pub struct Config {
    ...
    /// When `true`, the TUI avoids painting explicit panel backgrounds.
    pub tui_transparent_background: bool,
...
impl Config {
    ...
    pub(crate) async fn load_config_with_layer_stack(
        ...
        let config = Self {
            ...
            tui_transparent_background: cfg
                .tui
                .as_ref()
                .map(|t| t.transparent_background)
                .unwrap_or(false),
            otel: {
